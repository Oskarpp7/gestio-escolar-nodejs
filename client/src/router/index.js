...
const routes = [
  ...
  { path: '/login', name: 'login', component: Login, meta: { public: true, transition: 'fade' } },
  { path: '/dashboard', name: 'dashboard', component: Dashboard, meta: { requiresAuth: true, transition: 'slide-left' } },
  {
    path: '/admin/pricing',
    name: 'admin-pricing',
  ...
  { path: '/:pathMatch(.*)*', name: 'not-found', component: Dashboard, meta: { public: true } }
]
